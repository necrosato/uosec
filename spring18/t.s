...
0000000000000570 <deregister_tm_clones>:
 570:	48 8d 3d b9 0a 20 00 	lea    0x200ab9(%rip),%rdi        # 201030 <__TMC_END__>
 577:	55                   	push   %rbp
 578:	48 8d 05 b1 0a 20 00 	lea    0x200ab1(%rip),%rax        # 201030 <__TMC_END__>
...
00000000000005b0 <register_tm_clones>:
 ...
 5b7:	48 8d 35 72 0a 20 00 	lea    0x200a72(%rip),%rsi        # 201030 <__TMC_END__>
 5be:	55                   	push   %rbp
...
0000000000000600 <__do_global_dtors_aux>:
 600:	80 3d 29 0a 20 00 00 	cmpb   $0x0,0x200a29(%rip)        # 201030 <__TMC_END__>
 ...
 617:	48 8b 3d 0a 0a 20 00 	mov    0x200a0a(%rip),%rdi        # 201028 <__dso_handle>
 61e:	e8 0d ff ff ff       	callq  530 <__cxa_finalize@plt>
 623:	e8 48 ff ff ff       	callq  570 <deregister_tm_clones>
 628:	c6 05 01 0a 20 00 01 	movb   $0x1,0x200a01(%rip)        # 201030 <__TMC_END__>
 62f:	5d                   	pop    %rbp
 630:	c3                   	retq   
...
000000000000064a <main>:
 ...
 659:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
 660:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
 667:	eb 0a                	jmp    673 <main+0x29>
 669:	8b 45 fc             	mov    -0x4(%rbp),%eax
 66c:	01 45 f8             	add    %eax,-0x8(%rbp)
 66f:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
 673:	81 6d fc e8 03 00 00 	subl   $0x3e8,-0x4(%rbp)
 67a:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
 67e:	75 e9                	jne    669 <main+0x1f>
 680:	8b 45 f8             	mov    -0x8(%rbp),%eax
 683:	89 c6                	mov    %eax,%esi
 685:	48 8d 3d 98 00 00 00 	lea    0x98(%rip),%rdi        # 724 <_IO_stdin_used+0x4>
 68c:	b8 00 00 00 00       	mov    $0x0,%eax
 691:	e8 8a fe ff ff       	callq  520 <printf@plt>
...
00000000000006a0 <__libc_csu_init>:
 ...
 6a7:	41 55                	push   %r13
 6a9:	41 54                	push   %r12
 6ab:	4c 8d 25 36 07 20 00 	lea    0x200736(%rip),%r12        # 200de8 <__frame_dummy_init_array_entry>
 6b2:	55                   	push   %rbp
 6b3:	48 8d 2d 36 07 20 00 	lea    0x200736(%rip),%rbp        # 200df0 <__init_array_end>
 6ba:	53                   	push   %rbx
